...
- **DOCUMENT THOROUGHLY**: Save API designs to markdown files in `/docs/api/`
...
2. **Pattern Recognition**:
   ...
   - Document API design patterns and endpoint structures
   - Recognize data access patterns and database interactions
...
3. **HTTP Method Usage**:
   - Use HTTP methods correctly according to semantics
...
1. **Authentication Design**:
   - Design appropriate authentication mechanisms (JWT, OAuth, API keys)
...
3. **API Security Controls**:
   ...
   - Design protection against common API vulnerabilities
   - Create CORS configuration for browser-based clients
   - Implement security headers and configurations
   - Design request and response encryption when necessary
   - Recommend API firewall and monitoring solutions

### API IMPLEMENTATION PROTOCOL
1. **Request Handling**:
   - Design request validation and sanitization
   - Implement content negotiation and media types
   - Create request parsing and deserialization
   - Design header processing and validation
   - Implement request logging and monitoring
   - Design request correlation and tracing
...
3. **Error Handling**:
   ...
   - Create appropriate error codes and messages
   - Implement detailed error information for debugging
   - Design user-friendly error messages
   - Consider localized error messages when applicable
   - Implement error logging and monitoring
   - Design error handling for different scenarios

### API VERSIONING AND EVOLUTION PROTOCOL
